...
contract OrangeVaultV1CamelotScenario2Test is BaseTest {
    ...
    function __setUp() internal virtual {
        ...
        collateralToken0 = IERC20(aaveAddr.ausdcAddr);
        debtToken1 = IERC20(aaveAddr.vDebtWethAddr);
        ...
        params.setDepositCap(900_000 * 1e6);
    ...
    function setUp() public {
        ...
        deal(address(token0), carol, 1200 * 1e6);
        deal(address(token1), carol, 1_200_000 ether);
    ...
    function test_scenario0() public {
        ...
        vm.prank(address(11));
        uint _shares = vault.deposit(10_000 * 1e6, _maxAsset, new bytes32[](0));
        skip(1);
        vm.prank(address(12));
        uint _shares2 = vault.deposit(10_000 * 1e6, _maxAsset, new bytes32[](0));
        skip(1);

        assertEq(token0.balanceOf(address(11)), INITIAL_BAL - (10_000 * 1e6));
        assertEq(token0.balanceOf(address(12)), INITIAL_BAL - (10_000 * 1e6));
        assertEq(vault.balanceOf(address(11)), 10_000 * 1e6 - 1e3);
        ...
        skip(1);
        assertEq(token0.balanceOf(address(11)), INITIAL_BAL - 1e3);
